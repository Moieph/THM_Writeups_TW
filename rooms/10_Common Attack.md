...
<summary><strong>Software Updates</strong></summary>
  ...
  - 安全性更新（Patch）：
    - 解決已知的 漏洞（vulnerability）
    - 一旦被公開，駭客利用同樣漏洞進行攻擊

---

📚 實際案例：EternalBlue（藍色永恆） 漏洞：


| 項目           | 說明 |
|----------------|------|
| 🏷️ 名稱        | EternalBlue（藍色永恆） |
| 🔍 發現者       | 美國 NSA（國安局），但在 2017 年遭外洩 |
| 🖥️ 影響系統     | Windows 系統核心元件，允許遠端駭客取得「最高系統控制權限」 |
| ⚠️ 後果         | 成為 **WannaCry 勒索病毒** 傳播的核心漏洞 |
| 🛠️ 微軟修補時間 | 早於爆發事件幾個月就釋出 MS17-010 更新 |
| ❗ 問題核心     | **許多人沒有更新系統**，導致災難性感染（數百萬台電腦被加密） |

- Win 7、XP 等已是 EOL（End Of Life）：停止支援 = 永遠不會修漏洞 = 非常危險
